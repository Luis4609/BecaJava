...
public class Especie {
	...
	private int _VolumnenDeSustrato;
	...
	public int get_VolumnenDeSustrato() {
		return _VolumnenDeSustrato;
	}

	public void set_VolumnenDeSustrato(int _VolumnenDeSustrato) {
		this._VolumnenDeSustrato = _VolumnenDeSustrato;
	}
	...
	public String get_Transplante() {
		return _Transplante;
	}

	public void set_Transplante(String _Transplante) {
		this._Transplante = _Transplante;
	}
	...
	public String toString() {
		return "Especie [_TiempoMinGerminacion=" + _TiempoMinGerminacion + ", _TiempoMaxGerminacion="
				+ _TiempoMaxGerminacion + ", _Distancia=" + _Distancia + ", _VolumnenDeSustrato=" + _VolumnenDeSustrato
				...
				+ ", _RecoleccionMax=" + _RecoleccionMax + ", _Nombre=" + _Nombre + ", _Transplante=" + _Transplante
	...
	public static void main(String[] args) {
		...
		especie.set_Transplante("No necesita");
		especie.set_TipoSiembra("A golpes");
		especie.set_Distancia(10);
		especie.set_VolumnenDeSustrato(9);
		...
		especie.set_Distancia(10);
		especie.set_VolumnenDeSustrato(5);
